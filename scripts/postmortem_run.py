...
"""Claude trade post-mortems for the noches bots.
    ...
    .venv/bin/python scripts/postmortem_run.py --bot bot1 --n 6 --synth-tier smart

    # nightly full run over losers via Batch API (50% cheaper):
    .venv/bin/python scripts/postmortem_run.py --bot bot1 --n 40 --mode batch
    # ... then when batch_status == ended:
    .venv/bin/python scripts/postmortem_run.py --bot bot1 --collect <batch_id>
