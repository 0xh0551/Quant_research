...
BOT_CFG = {
    "bot2": ("bybit", USER_DATA / "bot2_config.json"),
    "bot3": ("bybit", USER_DATA / "bot3_config.json"),
    "bot5": ("bybit", USER_DATA / "bot5_config.json"),
    "bot4": ("okx", USER_DATA / "bot4_config.json"),
    "bot1": ("gate", USER_DATA / "bot1_config.json"),
    "bot6": ("hyperliquid", USER_DATA / "bot6_config.json"),
}
...
def _pairs_from_assignments() -> dict[str, list[str]]:
    ...
    bot5/bot6 too, which are outside the rotation file."""
