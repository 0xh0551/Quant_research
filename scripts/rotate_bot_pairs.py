...
BOTS = {
    ...
    "bender": {
        ...
        "exchange": "bybit", "trade_timeframe": "15m", "score_timeframe": "15m",
        "score_venues": ("bybit",), "quote": "USDT",
        "config": NOCHES / "bender_config.json",
        "sqlite": NOCHES / "bender.sqlite",
        "models_dir": NOCHES / "models" / "Bender_",
        "manifest_path": None, "default_strategy": None,
        # سبدِ گسترده‌تر از Gadget (۶ کاندید، max_open_trades=5) تا انتخابِ بیشتری
...
def bybit_liquid_bases(min_quote_vol_24h: float, ttl_hours: float = 6.0) -> set[str] | None:
    ...
    مثل gate_liquid_bases ولی روی ونیوِ خودِ Bender (bybit) — فیلترِ Gate برای یک باتِ
