...
The walk-forward scan promotes edges that the live bots (bot5, bot6) then
...
DEFAULT_DB_PATHS = {
    "bot5": "/home/h0551user/noches/user_data/bot5.sqlite",
    "bot6": "/home/h0551user/noches/user_data/bot6.sqlite",
}
