...
Owner asks (2026-08-19):
  * «چرا فقط Popeye اکچوئیتور دارد؟ هر باتی اکچوئیتور خودش را داشته باشد» → one tuner,
...
# (Popeye v3 08-12، Mickey pooled 08-12، Wall_E v5 07-27، Klaymen v1.7 08-09، ...).
BOT_EPOCH = {
    "Popeye": "2026-08-12", "Mickey": "2026-08-12", "Wall_E": "2026-07-27",
    "Gort": "2026-08-10", "Klaymen": "2026-08-09", "Bender": "2026-08-03", "Gadget": "2026-08-01",
}
