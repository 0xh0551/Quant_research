...
const I18N = {
  fa: {
    ...
    home_title: 'میز فرمان',
    home_lead: 'هر بخش یک کارت زنده است — روی کارت بزنید تا باز شود',
    home_updated: 'به‌روزرسانی {when}',
    home_open: 'باز کردن',
    home_live: 'زنده',
    ...
    home_k_refreshed: 'به‌روز شده', home_k_venues: 'صرافی', home_last_24h: 'در ۲۴ ساعت اخیر',
    home_k_scannable: 'قابل اسکن', home_k_stale3d: 'کهنه (>۳ روز)',
    home_k_ready_ds: 'دیتاست آماده', home_k_runs: 'اجرا', home_k_tfs: 'تایم‌فریم',
    ...
    home_k_book: 'حجم باز', home_k_hhi: 'تمرکز HHI', home_k_assets: 'دارایی',
    ...
    home_seg_lev: 'اهرم', home_seg_open: 'باز', home_seg_pnl: 'سود/زیان',
    home_inv_fresh: '{n} تازه · {s} کهنه',
    home_q_meter: '{a} از {b}', home_q_minbars: 'حداقل {n} کندل',
    home_q_median: 'میانهٔ طول دیتاست: {n} کندل',
    home_last_run: 'آخرین اجرا {when}', home_no_runs: 'هنوز اجرایی ثبت نشده',
    home_ins_top: 'پرتکرارترین استراتژی‌ها در لبه‌های برتر',
    home_lab_note: 'بک‌تست تک‌استراتژی با پارامترهای دلخواه + بهینه‌سازی',
    home_edges_alerts: '{n} هشدار تایم‌فریم',
    home_f_tested: 'آزمون‌شده', home_f_ever: 'پاس‌شده', home_f_deflated: 'پس از تعدیل',
    home_trials_runs: 'مجموع اجراها: {n}',
    home_cap_tightest: 'تنگ‌ترین: {s} تا {v}',
    home_cx_note: '{n} نماد در کل انبار داده',
    home_fleet_lev_cap: 'سقف {n}×', home_fleet_pos: '{n} پوزیشن · {b} ربات',
    home_fleet_alerts: '{n} هشدار ریسک', home_fleet_ok: 'در محدودهٔ مجاز',
    home_stress_n: '{n} سناریو · {l} لیکوییدیشن',
    home_a_intended: 'آلفا', home_a_fees: 'کارمزد', home_a_exit: 'اسلیپیج خروج', home_a_funding: 'فاندینگ',
    home_attr_worst: 'بیشترین اصطکاک اجرا: {bot} ({v})',
    home_alt_note: 'DVOL اتریوم {eth} · نسبت لانگ/شورت {ls}',
    home_pipe_fresh: 'تازگی آرتیفکت‌ها',
    home_pipe_running: 'مرحلهٔ {step} — {for}',
    home_pipe_worst: 'دیرترین: {name} ({when})',
    home_pipe_all_ok: 'همهٔ جاب‌ها به‌موقع اجرا شده‌اند',
  ...
  en: {
    ...
    home_lead: 'Every section is a live card — click one to open it',
    home_updated: 'updated {when}',
    home_open: 'Open',
    home_live: 'live',
    ...
    home_k_refreshed: 'Refreshed', home_k_venues: 'Venues', home_last_24h: 'in the last 24h',
    home_k_scannable: 'Scannable', home_k_stale3d: 'Stale (>3d)',
    home_k_ready_ds: 'Datasets ready', home_k_runs: 'Runs', home_k_tfs: 'Timeframes',
    ...
    home_k_book: 'Open book', home_k_hhi: 'HHI concentration', home_k_assets: 'assets',
    ...
    home_seg_lev: 'Leverage', home_seg_open: 'Open', home_seg_pnl: 'PnL',
    home_inv_fresh: '{n} fresh · {s} stale',
    home_q_meter: '{a} of {b}', home_q_minbars: 'min {n} bars',
    home_q_median: 'Median dataset length: {n} bars',
    home_last_run: 'last run {when}', home_no_runs: 'No runs logged yet',
    home_ins_top: 'Most frequent strategies among top edges',
    home_lab_note: 'Single-strategy backtest with custom params + optimizer',
    home_edges_alerts: '{n} timeframe alerts',
    home_f_tested: 'Tested', home_f_ever: 'Ever passed', home_f_deflated: 'After deflation',
    home_trials_runs: 'Total runs: {n}',
    home_cap_tightest: 'Tightest: {s} at {v}',
    home_cx_note: '{n} symbols across the store',
    home_fleet_lev_cap: 'cap {n}×', home_fleet_pos: '{n} positions · {b} bots',
    home_fleet_alerts: '{n} risk alerts', home_fleet_ok: 'Within limits',
    home_stress_n: '{n} scenarios · {l} liquidations',
    home_a_intended: 'Alpha', home_a_fees: 'Fees', home_a_exit: 'Exit slip', home_a_funding: 'Funding',
    home_attr_worst: 'Highest execution drag: {bot} ({v})',
    home_alt_note: 'ETH DVOL {eth} · long/short ratio {ls}',
    home_pipe_fresh: 'Artifact freshness',
    home_pipe_running: '{step} stage — {for}',
    home_pipe_worst: 'Most overdue: {name} ({when})',
    home_pipe_all_ok: 'Every job ran on time',
