...
const I18N = {
  fa: {
    ...
    /* ── home screen (launcher of live widget tiles) ──────────────── */
    nav_home: 'میز فرمان',
    title_home: 'میز فرمان', sub_home: 'نمای کلی همهٔ بخش‌ها',
    home_back: 'بازگشت به میز فرمان',
    home_running: 'در حال اجرا',
    home_slow: 'پاسخ سرور خیلی طول کشید',
    home_err_stale: 'داده‌های قدیمی نمایش داده می‌شود',
    home_err_none: 'بارگیری داده ناموفق بود',
    home_never: '—',
    home_just_now: 'همین حالا',
    home_ago_min: '{n} دقیقه پیش',
    home_ago_hour: '{n} ساعت پیش',
    home_ago_day: '{n} روز پیش',
    home_chip_tool: 'ابزار',

    home_g_data: 'داده',
    home_g_research: 'پژوهش',
    home_g_edge: 'لبه و اجرا',
    home_g_risk: 'ریسک و پرتفوی',
    home_g_ops: 'عملیات',

    home_cmdk_btn: 'جستجوی بخش‌ها',
    home_cmdk_ph: 'نام بخش را بنویسید…',
    home_cmdk_title: 'جستجوی سریع بخش‌ها (Ctrl+K)',
    home_cmdk_none: 'بخشی با این نام پیدا نشد',

    /* KPI labels */
    home_k_datasets: 'دیتاست', home_k_symbols: 'نماد', home_k_size: 'حجم',
    home_k_venues: 'صرافی', 
    home_k_scannable: 'قابل اسکن', home_k_stale3d: 'کهنه (>۳ روز)',
    home_k_runs: 'اجرا', 
    home_k_strategies: 'استراتژی',
    home_k_best_sharpe: 'بهترین شارپ OOS', home_k_oos_ret: 'بازده OOS',
    home_k_deployable: 'قابل استقرار',
    home_k_pbo: 'PBO میانه',
    home_k_unique: 'فرضیهٔ یکتا', home_k_pass_rate: 'نرخ پاس',
    home_k_median_cap: 'ظرفیت میانه', home_k_books: 'دفتر سفارش',
    home_k_multivenue: 'نماد چندصرافی',
    home_k_equity: 'ایکوییتی ناوگان', 
    home_k_net_delta: 'دلتای خالص', 
    home_k_book: 'حجم باز', home_k_hhi: 'تمرکز HHI', 
    home_k_worst_loss: 'بدترین سناریو', 
    home_k_net: 'خالص', home_k_intended: 'آلفای هدف', 
    home_k_dvol_btc: 'DVOL بیت‌کوین', home_k_liq24: 'لیکوییدیشن ۲۴ساعته',
    home_k_jobs_ok: 'جاب سالم', home_k_late: 'دیرکرد', home_k_missing: 'غایب',
    home_k_live_pairs: 'جفت‌ارز زنده', home_k_bots: 'ربات', 
    home_k_errors: 'خطا', home_k_warnings: 'هشدار',

    /* in-tile controls + notes */
    home_a_intended: 'آلفا', home_a_fees: 'کارمزد', home_a_exit: 'اسلیپیج خروج', home_a_funding: 'فاندینگ',

    /* ── home: chart vocabulary labels ────────────────────────────── */
    home_b_event_risk: 'ریسک رویداد', home_b_dvol_pct: 'صدک نوسان', home_b_ls_skew: 'اریبی لانگ/شورت',
    home_f_scanned: 'اسکن‌شده', home_f_passed: 'پاس‌شده', home_f_robust: 'مقاوم', home_f_deployable: 'قابل استقرار',
    home_a_entry: 'اسلیپیج ورود',
    home_h_ago: '{n} ساعت پیش',
    home_k_newest: 'تازه‌ترین داده',
    home_k_median_span: 'میانهٔ تاریخچه',
    home_k_watched: 'نماد زیر نظر',
    home_k_tightest: 'تنگ‌ترین',
    home_k_positions: 'پوزیشن',
    home_k_scenarios: 'سناریو',
    home_k_window: 'پنجره',
    home_u_yr: 'سال', home_u_d: 'روز',
    home_fleet_cap: 'سقف {n}×',

    /* ── home screen: dense-wall additions ────────────────────────── */
    home_all: 'همه',
    home_collapse: 'جمع کردن منو',
    home_k_median_bars: 'میانهٔ کندل',
    home_k_ls: 'لانگ/شورت',
    home_k_params: 'پارامتر',
    home_k_ranked: 'رتبه‌بندی‌شده',
    home_k_deflated: 'پس از تعدیل',
    home_k_best_carry: 'بهترین کری',
    home_k_assets_n: 'دارایی',
    home_k_liquidations: 'لیکوییدیشن',
    home_k_dvol_eth: 'DVOL اتریوم',
    home_k_dropped: 'حذف‌شده',
    home_k_lines: 'خط لاگ',
  ...
  en: {
    ...
    /* ── home screen (launcher of live widget tiles) ──────────────── */
    nav_home: 'Home',
    title_home: 'Mission Control', sub_home: 'Every section at a glance',
    home_back: 'Back to mission control',
    home_running: 'running',
    home_slow: 'server took too long',
    home_err_stale: 'showing the last good data',
    home_err_none: 'could not load data',
    home_never: '—',
    home_just_now: 'just now',
    home_ago_min: '{n}m ago',
    home_ago_hour: '{n}h ago',
    home_ago_day: '{n}d ago',
    home_chip_tool: 'tool',

    home_g_data: 'Data',
    home_g_research: 'Research',
    home_g_edge: 'Edges & execution',
    home_g_risk: 'Risk & portfolio',
    home_g_ops: 'Operations',

    home_cmdk_btn: 'Search sections',
    home_cmdk_ph: 'Type a section name…',
    home_cmdk_title: 'Quick section search (Ctrl+K)',
    home_cmdk_none: 'No section matches that',

    /* KPI labels */
    home_k_datasets: 'Datasets', home_k_symbols: 'Symbols', home_k_size: 'Size',
    home_k_venues: 'Venues', 
    home_k_scannable: 'Scannable', home_k_stale3d: 'Stale (>3d)',
    home_k_runs: 'Runs', 
    home_k_strategies: 'Strategies',
    home_k_best_sharpe: 'Best OOS Sharpe', home_k_oos_ret: 'OOS return',
    home_k_deployable: 'Deployable',
    home_k_pbo: 'Median PBO',
    home_k_unique: 'Unique hypotheses', home_k_pass_rate: 'Pass rate',
    home_k_median_cap: 'Median capacity', home_k_books: 'Order books',
    home_k_multivenue: 'Multi-venue symbols',
    home_k_equity: 'Fleet equity', 
    home_k_net_delta: 'Net delta', 
    home_k_book: 'Open book', home_k_hhi: 'HHI concentration', 
    home_k_worst_loss: 'Worst scenario', 
    home_k_net: 'Net', home_k_intended: 'Intended alpha', 
    home_k_dvol_btc: 'BTC DVOL', home_k_liq24: '24h liquidations',
    home_k_jobs_ok: 'Jobs healthy', home_k_late: 'Late', home_k_missing: 'Missing',
    home_k_live_pairs: 'Live pairs', home_k_bots: 'Bots', 
    home_k_errors: 'Errors', home_k_warnings: 'Warnings',

    /* in-tile controls + notes */
    home_a_intended: 'Alpha', home_a_fees: 'Fees', home_a_exit: 'Exit slip', home_a_funding: 'Funding',

    /* ── home: chart vocabulary labels ────────────────────────────── */
    home_b_event_risk: 'Event risk', home_b_dvol_pct: 'Vol percentile', home_b_ls_skew: 'Long/short skew',
    home_f_scanned: 'Scanned', home_f_passed: 'Passed', home_f_robust: 'Robust', home_f_deployable: 'Deployable',
    home_a_entry: 'Entry slip',
    home_h_ago: '{n}h ago',
    home_k_newest: 'Newest data',
    home_k_median_span: 'Median history',
    home_k_watched: 'Symbols watched',
    home_k_tightest: 'Tightest',
    home_k_positions: 'Positions',
    home_k_scenarios: 'Scenarios',
    home_k_window: 'Window',
    home_u_yr: 'yr', home_u_d: 'd',
    home_fleet_cap: 'cap {n}×',

    /* ── home screen: dense-wall additions ────────────────────────── */
    home_all: 'All',
    home_collapse: 'Collapse menu',
    home_k_median_bars: 'Median bars',
    home_k_ls: 'Long/short',
    home_k_params: 'Params',
    home_k_ranked: 'Ranked',
    home_k_deflated: 'After deflation',
    home_k_best_carry: 'Best carry',
    home_k_assets_n: 'Assets',
    home_k_liquidations: 'Liquidations',
    home_k_dvol_eth: 'ETH DVOL',
    home_k_dropped: 'Dropped',
    home_k_lines: 'Log lines',
