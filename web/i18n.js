...
const I18N = {
  fa: {
    ...
    home_k_refreshed: 'به‌روز شده', home_k_venues: 'صرافی', 
    home_k_scannable: 'قابل اسکن', home_k_stale3d: 'کهنه (>۳ روز)',
    home_k_ready_ds: 'دیتاست آماده', home_k_runs: 'اجرا', 
    home_k_strategies: 'استراتژی',
    home_k_best_sharpe: 'بهترین شارپ OOS', home_k_oos_ret: 'بازده OOS',
    home_k_passed: 'پاس‌شده', home_k_deployable: 'قابل استقرار',
    ...
    home_k_equity: 'ایکوییتی ناوگان', home_k_gross_lev: 'اهرم ناخالص',
    home_k_net_delta: 'دلتای خالص', 
    home_k_book: 'حجم باز', home_k_hhi: 'تمرکز HHI', 
    home_k_worst_loss: 'بدترین سناریو', home_k_of_equity: 'از ایکوییتی',
    home_k_net: 'خالص', home_k_intended: 'آلفای هدف', home_k_mfe: 'ضبط MFE',
  ...
  en: {
    ...
    home_k_refreshed: 'Refreshed', home_k_venues: 'Venues', 
    home_k_scannable: 'Scannable', home_k_stale3d: 'Stale (>3d)',
    home_k_ready_ds: 'Datasets ready', home_k_runs: 'Runs', 
    home_k_strategies: 'Strategies',
    home_k_best_sharpe: 'Best OOS Sharpe', home_k_oos_ret: 'OOS return',
    home_k_passed: 'Passed', home_k_deployable: 'Deployable',
    ...
    home_k_equity: 'Fleet equity', home_k_gross_lev: 'Gross leverage',
    home_k_net_delta: 'Net delta', 
    home_k_book: 'Open book', home_k_hhi: 'HHI concentration', 
    home_k_worst_loss: 'Worst scenario', home_k_of_equity: 'of equity',
    home_k_net: 'Net', home_k_intended: 'Intended alpha', home_k_mfe: 'MFE capture',
