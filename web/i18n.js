...
const I18N = {
  fa: {
    ...
    home_k_scanned: 'اسکن‌شده', home_k_passed: 'پاس‌شده', home_k_deployable: 'قابل استقرار',
    ...
    home_k_net_delta: 'دلتای خالص', home_k_corr: 'همبستگی میانگین',
    home_k_book: 'حجم باز', home_k_hhi: 'تمرکز HHI', 
    home_k_worst_loss: 'بدترین سناریو', home_k_of_equity: 'از ایکوییتی',
    home_k_net: 'خالص', home_k_intended: 'آلفای هدف', home_k_fees: 'کارمزد', home_k_mfe: 'ضبط MFE',
    ...
    home_k_live_pairs: 'جفت‌ارز زنده', home_k_bots: 'ربات', home_k_retrain_q: 'صف بازآموزی',
    home_k_errors: 'خطا', home_k_warnings: 'هشدار',

    /* in-tile controls + notes */
    home_seg_tf: 'تایم‌فریم', home_seg_venue: 'صرافی',
    home_seg_passed: 'پاس‌شده', home_seg_robust: 'مقاوم',
    home_seg_lev: 'اهرم', home_seg_open: 'باز', 
    home_q_meter: '{a} از {b}', home_q_minbars: 'حداقل {n} کندل',
    home_no_runs: 'هنوز اجرایی ثبت نشده',
    home_ins_top: 'پرتکرارترین استراتژی‌ها در لبه‌های برتر',
    home_lab_note: 'بک‌تست تک‌استراتژی با پارامترهای دلخواه + بهینه‌سازی',
    home_f_tested: 'آزمون‌شده', home_f_ever: 'پاس‌شده', home_f_deflated: 'پس از تعدیل',
    home_trials_runs: 'مجموع اجراها: {n}',
    home_cx_note: '{n} نماد در کل انبار داده',
    home_fleet_lev_cap: 'سقف {n}×', home_fleet_pos: '{n} پوزیشن · {b} ربات',
    home_fleet_alerts: '{n} هشدار ریسک', 
    ...
    home_k_trades: 'معامله',
    home_k_assets_n: 'دارایی',
    home_k_top1: 'بزرگ‌ترین',
    home_k_liquidations: 'لیکوییدیشن',
    home_k_dvol_eth: 'DVOL اتریوم',
    home_k_dropped: 'حذف‌شده',
    home_k_lines: 'خط لاگ',
    home_hdr_biggest: 'بزرگ‌ترین دیتاست',
    home_hdr_newest: 'تازه‌ترین دانلودها',
    home_hdr_bars: 'توزیع طول دیتاست',
    home_hdr_recent: 'اجراهای اخیر',
    home_hdr_strategies: 'استراتژی‌های موجود',
    home_hdr_leaderboard: 'جدول برترها',
    home_hdr_by_tf: 'به تفکیک تایم‌فریم',
    home_hdr_trend: 'روند پاس‌شده‌ها',
    home_hdr_top_edges: 'لبه‌های برتر',
    home_hdr_pass_by_strategy: 'نرخ پاس به تفکیک استراتژی',
    home_hdr_tightest: 'تنگ‌ترین ظرفیت‌ها',
    home_hdr_impact_k: 'ضریب اثر بازار (k)',
    home_hdr_carry: 'بهترین کری فاندینگ',
    home_hdr_bots_30d: 'عملکرد ۳۰ روزهٔ ربات‌ها',
    home_hdr_weights: 'وزن دارایی‌ها',
    home_hdr_scenarios: 'سناریوها ({n})',
    home_hdr_components: 'اجزای سود و زیان',
    home_hdr_drag_by_bot: 'اصطکاک اجرا',
    home_hdr_funding_extremes: 'فاندینگ‌های حدی',
    home_hdr_jobs: 'وضعیت جاب‌ها',
  ...
  en: {
    ...
    home_k_scanned: 'Scanned', home_k_passed: 'Passed', home_k_deployable: 'Deployable',
    ...
    home_k_net_delta: 'Net delta', home_k_corr: 'Avg correlation',
    home_k_book: 'Open book', home_k_hhi: 'HHI concentration', 
    home_k_worst_loss: 'Worst scenario', home_k_of_equity: 'of equity',
    home_k_net: 'Net', home_k_intended: 'Intended alpha', home_k_fees: 'Fees', home_k_mfe: 'MFE capture',
    ...
    home_k_live_pairs: 'Live pairs', home_k_bots: 'Bots', home_k_retrain_q: 'Retrain queue',
    home_k_errors: 'Errors', home_k_warnings: 'Warnings',

    /* in-tile controls + notes */
    home_seg_tf: 'Timeframe', home_seg_venue: 'Venue',
    home_seg_passed: 'Passed', home_seg_robust: 'Robust',
    home_seg_lev: 'Leverage', home_seg_open: 'Open', 
    home_q_meter: '{a} of {b}', home_q_minbars: 'min {n} bars',
    home_no_runs: 'No runs logged yet',
    home_ins_top: 'Most frequent strategies among top edges',
    home_lab_note: 'Single-strategy backtest with custom params + optimizer',
    home_f_tested: 'Tested', home_f_ever: 'Ever passed', home_f_deflated: 'After deflation',
    home_trials_runs: 'Total runs: {n}',
    home_cx_note: '{n} symbols across the store',
    home_fleet_lev_cap: 'cap {n}×', home_fleet_pos: '{n} positions · {b} bots',
    home_fleet_alerts: '{n} risk alerts', 
    ...
    home_hdr_biggest: 'Largest dataset',
    home_hdr_newest: 'Newest downloads',
    home_hdr_bars: 'Dataset length spread',
    home_hdr_recent: 'Recent runs',
    home_hdr_strategies: 'Available strategies',
    home_hdr_leaderboard: 'Leaderboard',
    home_hdr_by_tf: 'By timeframe',
    home_hdr_trend: 'Passed over time',
    home_hdr_top_edges: 'Top edges',
    home_hdr_pass_by_strategy: 'Pass rate by strategy',
    home_hdr_tightest: 'Tightest capacity',
    home_hdr_impact_k: 'Market-impact k',
    home_hdr_carry: 'Best funding carry',
    home_hdr_bots_30d: 'Bot performance, 30d',
    home_hdr_weights: 'Asset weights',
    home_hdr_scenarios: 'Scenarios ({n})',
    home_hdr_components: 'PnL components',
    home_hdr_drag_by_bot: 'Execution drag',
    home_hdr_funding_extremes: 'Funding extremes',
    home_hdr_jobs: 'Job status',
